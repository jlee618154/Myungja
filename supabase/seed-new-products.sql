...
from (select id from products where slug = 'airy-knit-bra-top') p
...
insert into product_images (product_id, color_name, sort_order, image_url)
select p.id, c.color_name, i.sort_order, i.image_url
from (select id from products where slug = 'breeze-crop-half-zip') p
...
insert into product_images (product_id, color_name, sort_order, image_url)
select p.id, c.color_name, i.sort_order, i.image_url
from (select id from products where slug = 'cool-touch-sleeveless') p
...
insert into product_images (product_id, color_name, sort_order, image_url)
select p.id, c.color_name, i.sort_order, i.image_url
from (select id from products where slug = 'daily-round-tee') p
...
insert into product_images (product_id, color_name, sort_order, image_url)
select p.id, c.color_name, i.sort_order, i.image_url
from (select id from products where slug = 'soft-jersey-cap-sleeve-tee') p
...
insert into product_images (product_id, color_name, sort_order, image_url)
select p.id, c.color_name, i.sort_order, i.image_url
from (select id from products where slug = 'warming-long-cardigan') p
